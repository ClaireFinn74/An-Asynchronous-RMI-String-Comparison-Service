...
public class StringServiceImpl extends UnicastRemoteObject implements StringsService
{
	...
	@Override
	public Resultator compare(String FirstString, String SecondString, String algo) throws RemoteException
	{
