...
public class MatchingStringImpl extends UnicastRemoteObject implements MatchingStringable
{
	...
	@Override
	// Using Resultator here to compare the two strings and get the output
	public Resultator compare(String FirstString, SecondString, Output)
{
